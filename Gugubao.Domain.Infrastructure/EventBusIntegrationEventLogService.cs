...
{
    public class EventBusIntegrationEventLogService : IEventBusIntegrationEventLogService
    {
        private readonly IEventBus _eventBus;
        private readonly MySqlDbContext _dbContext;
        private readonly ILogger<EventBusIntegrationEventLogService> _logger;
        private readonly IIntegrationEventLogService _eventLogService;
        private readonly Assembly _assembly;

        public EventBusIntegrationEventLogService(IEventBus eventBus,
            MySqlDbContext dbContext,
            ILogger<EventBusIntegrationEventLogService> logger,
            Assembly assembly,
